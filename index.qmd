...
authors: "Sierra Landacre, Pamela Mishaw, Pallak Singh, and Tim Leschke II"
date: '`r Sys.Date()`'
format:
  html:
    code-fold: true
...
Tim updated the references.bib file with the following references; [@quinlan], [@rachmawanto], [@yuan], [@boryczka], and [@breiman]...
